...
trait QueryFieldHelpers[Meta] extends NamesResolver {
  ...
  protected def OptLongSubtypeField[T <: Long]: OptLongSubtypeField[T, Meta] =
    named(
  ...
  protected def ObjectIdTaggedField[Tag]: ObjectIdTaggedField[Tag, Meta] =
    named(
  ...
  protected def OptUUIdSubtypeField[T <: UUID]: OptUUIDIdSubtypeField[T, Meta] =
    named(
  ...
  protected def EnumField[E <: Enumeration](
      e: E
  ): EnumField[e.Value, Meta] = named(
    new EnumField[e.Value, Meta](_, this, e(0))
  )

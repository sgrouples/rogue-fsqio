...
assertEquals(    qal.q, pq(("""db.outer.update({"innerList.a": 1}, {"$set": {"innerList.$.b": "blah"}}, false, false)""")))

    val qua = OuterR.where(_.innerArray.subfield(_.a) eqs 1).modify(_.innerArray.$.subfield(_.b) setTo "blah")
assertEquals(    qua.q, pq(("""db.outer.update({"innerArray.a": 1}, {"$set": {"innerArray.$.b": "blah"}}, false, false)""")))

    val upl = OuterR.where(_.innerList.subfield(_.a) eqs 1).modify(_.innerList.$.subfield(_.c) setTo List("blah", "bah"))
assertEquals(    upl.q, pq(("""db.outer.update({"innerList.a": 1}, {"$set": {"innerList.$.c": ["blah", "bah"]}}, false, false)""")))

    val upa = OuterR.where(_.innerArray.subfield(_.a) eqs 1).modify(_.innerArray.$.subfield(_.d) setTo List("blah", "bah"))
assertEquals(    upa.q, pq(("""db.outer.update({"innerArray.a": 1}, {"$set": {"innerArray.$.d": ["blah", "bah"]}}, false, false)""")))
...
assertEquals(    qol.q, pq(("""db.outer.update({"innerOptList.a": 1}, {"$set": {"innerOptList.$.b": "blah"}}, false, false)""")))

    val uoa = OuterR.where(_.innerOptArray.subfield(_.a) eqs 1).modify(_.innerOptArray.$.subfield(_.d) setTo List("blah", "bah"))
assertEquals(    uoa.q, pq(("""db.outer.update({"innerOptArray.a": 1}, {"$set": {"innerOptArray.$.d": ["blah", "bah"]}}, false, false)""")))

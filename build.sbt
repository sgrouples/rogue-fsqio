...
lazy val ccmacros = (project in file("ccmacros")).settings(defaultSettings)
lazy val cc = (project in file("cc")).dependsOn(field, core, ccmacros).settings(defaultSettings)

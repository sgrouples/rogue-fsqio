...
lazy val cc = (project in file("cc")).dependsOn(field).settings(defaultSettings)
lazy val root = (project in file(".")).settings(defaultSettings).aggregate(field,core,index,indexchecker,lift)
